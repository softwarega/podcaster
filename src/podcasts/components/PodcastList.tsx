...
const PodcastList: React.FC<Iprops> = ({ podcasts }) => {
  return (
...
const PodcastListItem: React.FC<{ podcast: Podcast }> = ({ podcast }) => {
  return (
    <li className="col-span-1 flex flex-col divide-y divide-gray-200 rounded-lg bg-white text-center shadow">
      <div className="flex flex-1 flex-col p-8">
        <img loading="lazy" className="mx-auto h-32 w-32 flex-shrink-0 rounded-full" src={podcast.getImage()} alt="" />
        <h3 title="Name" className="mt-6 text-sm font-medium text-gray-900">
          {podcast.getName()}
        </h3>
